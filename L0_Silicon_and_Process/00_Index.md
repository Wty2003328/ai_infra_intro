...
1. [Silicon_For_AI](01_Silicon_For_AI.md) — the canonical L0 deep-dive: physics → transistor → cell → node → lithography → yield → PDN → thermal.
...
Read [Silicon_For_AI](01_Silicon_For_AI.md) once end-to-end. It's the only page in this layer because every L0 concept feeds something concrete one or two layers up — there is no benefit to splitting into smaller pages.

After this layer, ascend to [L1 — Packaging & Memory Stack](../L1_Packaging_and_Memory/00_Index.md).
