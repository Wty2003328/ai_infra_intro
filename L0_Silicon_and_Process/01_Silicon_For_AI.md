...
> **Hands off to:** [L1 — Packaging & Memory](../L1_Packaging_and_Memory/00_Index.md), [L2 — Digital Design for AI](../L2_Digital_Design_for_AI/00_Index.md), [L3 — Microarchitecture](../L3_Microarchitecture/00_Index.md).
...
Full HBM and CoWoS treatment in [L1 — Packaging & Memory](../L1_Packaging_and_Memory/00_Index.md).
...
**Up the stack:** [L1 — Packaging & Memory Stack](../L1_Packaging_and_Memory/00_Index.md) → [L2 — Digital Design for AI](../L2_Digital_Design_for_AI/00_Index.md) → [L3 — Microarchitecture](../L3_Microarchitecture/00_Index.md).
