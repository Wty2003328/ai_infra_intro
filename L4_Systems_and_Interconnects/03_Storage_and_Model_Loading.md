...
> **Layer:** L4.
> **Prerequisites:** [Networking_and_Interconnect](01_Networking_and_Interconnect.md), [Rack_Scale_Design](02_Rack_Scale_Design.md), [HBM_Deep_Dive](../L1_Packaging_and_Memory/02_HBM_Deep_Dive.md).
> **Hands off to:** [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md), [Distributed_Training](../L7_Training_Stack/03_Distributed_Training.md), [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md).
...
GGUF is not typically used in data-center inference (where FP16/BF16 is loaded directly to GPU), but is relevant for understanding the quantization landscape (see [Quantization](../L6_Algorithms_and_Models/05_Quantization.md)).
...
**Cross-references**
- [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md) — detailed KV cache layout and management.
- [Disaggregated_Serving_2025](../L8_Inference_and_Serving/10_Disaggregated_Serving_2025.md) — Mooncake-style KV pool and warm-pool model distribution.
- [Distributed_Training](../L7_Training_Stack/03_Distributed_Training.md) — FSDP, ZeRO, and checkpoint coordination.
- [Networking_and_Interconnect](01_Networking_and_Interconnect.md) — NVMe-oF and RDMA transport.

---

**Up the stack:** [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md), [Disaggregated_Serving_2025](../L8_Inference_and_Serving/10_Disaggregated_Serving_2025.md), [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md).
**Down the stack:** [Networking_and_Interconnect](01_Networking_and_Interconnect.md), [Rack_Scale_Design](02_Rack_Scale_Design.md), [HBM_Deep_Dive](../L1_Packaging_and_Memory/02_HBM_Deep_Dive.md).
