...
> **Prerequisites:** [GPU_Architecture](02_GPU_Architecture.md), [L1 HBM_Deep_Dive](../L1_Packaging_and_Memory/02_HBM_Deep_Dive.md), [L2 On_Chip_Memory_Hardware](../L2_Digital_Design_for_AI/01_On_Chip_Memory_Hardware.md).
...
**Up the stack:** [Blackwell_Architecture](04_Blackwell_Architecture.md) → all per-vendor pages → [L4 Networking & Interconnects](../L4_Systems_and_Interconnects/00_Index.md).
**Down the stack:** [GPU_Architecture](02_GPU_Architecture.md), [L1 HBM_Deep_Dive](../L1_Packaging_and_Memory/02_HBM_Deep_Dive.md).
