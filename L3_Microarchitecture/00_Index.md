...
6. [Google_TPU](06_Google_TPU.md) — non-GPU paradigm. MXU, SparseCore, ICI 3D torus, OCS.
7. [Huawei_Ascend](07_Huawei_Ascend.md) — DaVinci 3D Cube; SMIC-node compensations; HCCS.
8. [Cloud_ASICs](08_Cloud_ASICs.md) — AWS Trainium (VLIW NeuronCore), Meta MTIA (mesh inference).
9. [Specialty_Accelerators](09_Specialty_Accelerators.md) — Cerebras WSE-3, Groq LPU, Tenstorrent.
10. [Accelerator_Landscape_2026](10_Accelerator_Landscape_2026.md) — comparative landscape with standardized axes (FLOPS, BW, TDP, scale-up domain, software stack).
