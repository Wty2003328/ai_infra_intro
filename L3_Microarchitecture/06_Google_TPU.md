...
> **Prerequisites:** [ISA_and_Execution_Model](01_ISA_and_Execution_Model.md), [Memory_Hierarchy_and_Roofline](03_Memory_Hierarchy_and_Roofline.md), [L2 Systolic_Arrays_and_Dataflow](../L2_Digital_Design_for_AI/03_Systolic_Arrays_and_Dataflow.md).
> **Hands off to:** [L4 Networking & Interconnects](../L4_Systems_and_Interconnects/00_Index.md) (ICI 3D torus + OCS), [L5 Triton_and_Kernels](../L5_Kernels_and_Programming/04_Triton_and_Kernels.md) (Pallas / JAX).
...
Recap from [L2 Systolic_Arrays_and_Dataflow](../L2_Digital_Design_for_AI/03_Systolic_Arrays_and_Dataflow.md): each weight is reused 128× per fill, cutting operand bandwidth ~128× vs RF-fed MAC. Net: TPU can sustain 95% utilization on large dense GEMM with HBM bandwidth that would limit a GPU to ~40%.
...
**Up the stack:** [L4 Networking & Interconnects](../L4_Systems_and_Interconnects/00_Index.md), [L7 Distributed Training](../L7_Training_Stack/00_Index.md).
**Down the stack:** [ISA_and_Execution_Model](01_ISA_and_Execution_Model.md), [L2 Systolic_Arrays_and_Dataflow](../L2_Digital_Design_for_AI/03_Systolic_Arrays_and_Dataflow.md).
