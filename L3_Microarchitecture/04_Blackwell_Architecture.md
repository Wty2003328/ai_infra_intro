...
> **Prerequisites:** [GPU_Architecture](02_GPU_Architecture.md), [Memory_Hierarchy_and_Roofline](03_Memory_Hierarchy_and_Roofline.md), [L1 Advanced_Packaging](../L1_Packaging_and_Memory/01_Advanced_Packaging.md), [L2 FP_Unit_Design](../L2_Digital_Design_for_AI/02_FP_Unit_Design.md).
> **Hands off to:** [L4 Rack_Scale_Design](../L4_Systems_and_Interconnects/02_Rack_Scale_Design.md), [L6 Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md), all L8 inference pages.
...
The same silicon area runs at 1× FP16 OR 2× FP8 OR 4× FP4 throughput depending on the format. The MX shared exponent is decoded once per 32-element block, applied to all elements in the block — covered fully in [L2 FP_Unit_Design §6](../L2_Digital_Design_for_AI/02_FP_Unit_Design.md).
...
Covered in detail at [L2 On_Chip_Memory_Hardware §5](../L2_Digital_Design_for_AI/01_On_Chip_Memory_Hardware.md). TL;DR:
...
> Full Vera Rubin platform detail — confirmed specs, the Vera CPU, the VR200 NVL144 rack, and the Rubin CPX prefill GPU — lives in [Accelerator_Landscape_2026](10_Accelerator_Landscape_2026.md) §11.
...
**Up the stack:** [AMD_Instinct](05_AMD_Instinct.md), [L4 Networking & Interconnects](../L4_Systems_and_Interconnects/00_Index.md), [L6 Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md).
**Down the stack:** [GPU_Architecture](02_GPU_Architecture.md), [L1 Advanced_Packaging](../L1_Packaging_and_Memory/01_Advanced_Packaging.md), [L2 FP_Unit_Design](../L2_Digital_Design_for_AI/02_FP_Unit_Design.md).
