...
> **Layer:** L8. **Prerequisites:** [KV_Cache](01_KV_Cache.md), [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md). **Hands off to:** [Batching_and_Scheduling](03_Batching_and_Scheduling.md), [Long_Context_Engineering](06_Long_Context_Engineering.md).
...
Multi-Head Latent Attention (MLA) from DeepSeek-V2/V3 is covered in detail in [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md). This section focuses on the serving implications: what changes in the inference stack when the model uses MLA instead of MHA/GQA.
...
**Up (deeper):**
- [KV_Cache](01_KV_Cache.md) -- paged KV layout, PagedAttention, prefix caching, radix tree
- [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md) -- MHA, GQA, MLA architecture definitions
- [Quantization](../L6_Algorithms_and_Models/05_Quantization.md) -- FP8, FP4, INT8 quantization fundamentals

**Down (higher level):**
- [Batching_and_Scheduling](03_Batching_and_Scheduling.md) -- how KV cache size determines batch size and scheduling
- [Long_Context_Engineering](06_Long_Context_Engineering.md) -- ring attention, NSA, MoBA, context parallelism

**Lateral:**
- [Speculative_Decoding](04_Speculative_Decoding.md) -- speculative decoding benefits from smaller KV caches
- [Inference_Frameworks](08_Inference_Frameworks.md) -- framework support for KV compression
