...
> **Layer:** L8. **Prerequisites:** [Production_Architecture](15_Production_Architecture.md), [vLLM_Internals](09_vLLM_Internals.md), [Batching_and_Scheduling](03_Batching_and_Scheduling.md). **Hands off to:** [Production_Architecture](15_Production_Architecture.md).
...
**Remediation:** Reduce `max_num_seqs`, enable KV cache compression ([Modern_KV_Compression](02_Modern_KV_Compression.md)), or use quantized model (FP8/INT4) to free HBM.
