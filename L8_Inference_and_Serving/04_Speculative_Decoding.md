...
> **Layer:** L8. **Prerequisites:** [Batching_and_Scheduling](03_Batching_and_Scheduling.md), [Transformer_Internals](../L6_Algorithms_and_Models/01_Transformer_Internals.md). **Hands off to:** [Inference_Frameworks](08_Inference_Frameworks.md), [Production_Architecture](15_Production_Architecture.md).
...
Inside a continuous-batching loop (see [Batching_and_Scheduling](03_Batching_and_Scheduling.md)), each step becomes:
...
During verification, the target model writes KV cache entries for all $\gamma + 1$ candidate positions. If only $n < \gamma$ tokens are accepted, the rejected entries must be discarded. With paged KV cache (see [KV_Cache](01_KV_Cache.md)), this is a metadata operation:
...
**Next:** [Inference_Frameworks](08_Inference_Frameworks.md).
**See also:** [Batching_and_Scheduling](03_Batching_and_Scheduling.md), [KV_Cache](01_KV_Cache.md), [Production_Architecture](15_Production_Architecture.md).
