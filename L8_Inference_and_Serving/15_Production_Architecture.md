...
> **Layer:** L8.
> **Prerequisites:** [KV_Cache](01_KV_Cache.md), [Batching_and_Scheduling](03_Batching_and_Scheduling.md), [Speculative_Decoding](04_Speculative_Decoding.md), [Inference_Frameworks](08_Inference_Frameworks.md), [Kubernetes_and_Orchestration](13_Kubernetes_and_Orchestration.md), [Observability_and_Debugging](14_Observability_and_Debugging.md), [Disaggregated_Serving_2025](10_Disaggregated_Serving_2025.md).
...
> Full treatment — workload math, prefix-cache economics, offload tiers, cache-aware routing, SLO compounding, and NVIDIA Dynamo's agentic hints — lives in [Agentic_Inference](11_Agentic_Inference.md).
