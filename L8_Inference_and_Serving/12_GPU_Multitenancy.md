...
> **Position in the stack:** the resource-sharing layer between hardware ([GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md)) and orchestration ([Kubernetes_and_Orchestration](13_Kubernetes_and_Orchestration.md)). Decides how many workloads share one die and what "isolation" actually means.
...
- Up: [Kubernetes_and_Orchestration](13_Kubernetes_and_Orchestration.md), [Production_Architecture](15_Production_Architecture.md), [Observability_and_Debugging](14_Observability_and_Debugging.md) (interference debugging).
- Down: [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md) (SM/L2/HBM structure), [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md) (why decode is BW-bound).
- Siblings: [Batching_and_Scheduling](03_Batching_and_Scheduling.md) (intra-engine sharing), [Agentic_Inference](11_Agentic_Inference.md) (session workloads on shared fleets).
