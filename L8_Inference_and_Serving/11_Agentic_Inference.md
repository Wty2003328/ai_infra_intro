...
> **Position in the stack:** the 2026 successor workload to chat. Builds directly on [KV_Cache](01_KV_Cache.md), [Prefill_Decode_Disaggregation](05_Prefill_Decode_Disaggregation.md), [Batching_and_Scheduling](03_Batching_and_Scheduling.md), and [Long_Context_Engineering](06_Long_Context_Engineering.md); the model-side mechanics are in [Reasoning_Models](../L7_Training_Stack/06_Reasoning_Models.md).
...
3. **KV-cache compression** ([Modern_KV_Compression](02_Modern_KV_Compression.md)) — quantized (FP8/FP4) KV, eviction (H2O/SnapKV-class) for tolerant workloads; MLA-style architectural compression solves it at the model level.
...
- Prerequisites: [KV_Cache](01_KV_Cache.md), [Batching_and_Scheduling](03_Batching_and_Scheduling.md), [Prefill_Decode_Disaggregation](05_Prefill_Decode_Disaggregation.md).
- Siblings: [Long_Context_Engineering](06_Long_Context_Engineering.md), [Modern_KV_Compression](02_Modern_KV_Compression.md), [Disaggregated_Serving_2025](10_Disaggregated_Serving_2025.md), [Speculative_Decoding](04_Speculative_Decoding.md).
- Model side: [Reasoning_Models](../L7_Training_Stack/06_Reasoning_Models.md), [Frontier_Models_2025_2026](../L6_Algorithms_and_Models/07_Frontier_Models_2025_2026.md).
- Hardware: [Google_TPU](../L3_Microarchitecture/06_Google_TPU.md) (TPU 8i), [Accelerator_Landscape_2026](../L3_Microarchitecture/10_Accelerator_Landscape_2026.md) (Rubin CPX).
