...
> **Prerequisites:** [L0 Silicon_For_AI](../L0_Silicon_and_Process/01_Silicon_For_AI.md). Helpful: basic transmission-line theory, RC delay, eye-diagram analysis.
> **Hands off to:** [HBM_Deep_Dive](02_HBM_Deep_Dive.md) for the memory specialization, [L3 Microarchitecture](../L3_Microarchitecture/00_Index.md) for how the bandwidth is consumed.
...
The on-die deep-trench caps (covered in [L0](../L0_Silicon_and_Process/01_Silicon_For_AI.md)) handle the sub-100-ps regime that even MIM caps can't catch.
...
**Up the stack:** [HBM_Deep_Dive](02_HBM_Deep_Dive.md) → [L2 — Digital Design for AI](../L2_Digital_Design_for_AI/00_Index.md) → [L3 — Microarchitecture](../L3_Microarchitecture/00_Index.md).
