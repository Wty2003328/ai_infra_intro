...
1. [Advanced_Packaging](01_Advanced_Packaging.md) — interposers, embedded bridges, hybrid bonding, NV-HBI / EMIB / IF-AP, package-level PDN and thermal.
2. [HBM_Deep_Dive](02_HBM_Deep_Dive.md) — HBM channel topology, sense-amp physics, TSV RC, base-die logic, HBM3e/HBM4 transition, refresh-vs-thermal feedback, processing-in-memory.
...
|---|---|
| HBM3e: 1024-bit, 9.6 Gbps/pin → ~1.23 TB/s/stack; 8 stacks → ~9.8 TB/s/package | The "decode is bandwidth-bound" wall in [L3 Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md) |
...
Start with [Advanced_Packaging](01_Advanced_Packaging.md) for the package geometry, then [HBM_Deep_Dive](02_HBM_Deep_Dive.md) for the memory specialization. Cross-link forward to:

- [L3 — Microarchitecture](../L3_Microarchitecture/00_Index.md) for how this bandwidth is consumed by SMs / tensor cores.
- [L4 — Systems & Interconnects](../L4_Systems_and_Interconnects/00_Index.md) for what NVLink / NVSwitch does *across* packages, on top of NV-HBI *inside* the package.
