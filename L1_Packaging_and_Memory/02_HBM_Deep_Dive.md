...
> **Layer:** L1.
> **Prerequisites:** [L0 Silicon_For_AI](../L0_Silicon_and_Process/01_Silicon_For_AI.md), [Advanced_Packaging](01_Advanced_Packaging.md). DRAM device-physics primer assumed.
> **Hands off to:** [L3 Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md), then everything in [L8 inference engines](../L8_Inference_and_Serving/00_Index.md) that depends on the bandwidth wall.
...
For general TSV physics see [Advanced_Packaging §4](01_Advanced_Packaging.md). The HBM-specific issues:
...
Full coverage in [L3 Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md).
...
**Up the stack:** [L2 Digital Design for AI](../L2_Digital_Design_for_AI/00_Index.md) → [L3 Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md).
**See also:** [Advanced_Packaging](01_Advanced_Packaging.md) (the packaging substrate that makes HBM possible).
