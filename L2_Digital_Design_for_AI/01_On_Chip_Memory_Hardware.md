...
> **Layer:** L2.
> **Prerequisites:** [L0 Silicon_For_AI](../L0_Silicon_and_Process/01_Silicon_For_AI.md), [L1 HBM_Deep_Dive](../L1_Packaging_and_Memory/02_HBM_Deep_Dive.md). CMOS-cell familiarity.
> **Hands off to:** [FP_Unit_Design](02_FP_Unit_Design.md), [Systolic_Arrays_and_Dataflow](03_Systolic_Arrays_and_Dataflow.md), [L3 Microarchitecture](../L3_Microarchitecture/00_Index.md).
...
Full coverage at [L4 — Networking & Interconnects](../L4_Systems_and_Interconnects/00_Index.md).
...
**Up the stack:** [FP_Unit_Design](02_FP_Unit_Design.md) → [Systolic_Arrays_and_Dataflow](03_Systolic_Arrays_and_Dataflow.md) → [Digital_Design_For_AI](04_Digital_Design_For_AI.md) → [L3 Microarchitecture](../L3_Microarchitecture/00_Index.md).
