...
> **Layer:** L1.
> **Prerequisites:** [L0 Silicon_For_AI](../L0_Silicon_and_Process/Silicon_For_AI.md), [Advanced_Packaging](Advanced_Packaging.md). DRAM device-physics primer in [`digital_design/Memory.md`](../../digital_design/Memory.md) helps.
...
- [`digital_design/Memory.md`](../../digital_design/Memory.md) — DRAM device-physics primer.
- [`digital_design/Signal_Integrity_Reliability.md`](../../digital_design/Signal_Integrity_Reliability.md) — signaling-side companion.
- [`power/Power_Analysis_and_Signoff.md`](../../power/Power_Analysis_and_Signoff.md) — PHY power signoff.
