...
> **Layer:** L8.
> **Prerequisites:** [Rack_Scale_Design](../L4_Systems_and_Interconnects/Rack_Scale_Design.md), [Inference_Frameworks](Inference_Frameworks.md), [Production_Architecture](Production_Architecture.md).
> **Hands off to:** [Observability_and_Debugging](Observability_and_Debugging.md).
...
**Cross-references**
- [Rack_Scale_Design](../L4_Systems_and_Interconnects/Rack_Scale_Design.md) — physical infrastructure these orchestration tools manage.
- [Inference_Frameworks](Inference_Frameworks.md) — vLLM, SGLang, TensorRT-LLM, the engines being orchestrated.
- [Production_Architecture](Production_Architecture.md) — end-to-end serving stack design.
- [Observability_and_Debugging](Observability_and_Debugging.md) — DCGM, Nsight, TTFT/TPOT metrics for debugging scheduling issues.

---

**Up the stack:** [Observability_and_Debugging](Observability_and_Debugging.md).
**See also:** [Inference_Frameworks](Inference_Frameworks.md), [Production_Architecture](Production_Architecture.md), [Rack_Scale_Design](../L4_Systems_and_Interconnects/Rack_Scale_Design.md).
