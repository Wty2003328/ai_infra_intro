...
1. [Parallelism_Strategies](Parallelism_Strategies.md) — DP, TP, PP, EP, CP, SP with communication volume math. Foundational for all distributed training.
2. [Collectives_and_NCCL](Collectives_and_NCCL.md) — AllReduce algorithms, bandwidth modeling, NCCL internals.
3. [Distributed_Training](Distributed_Training.md) — FSDP, ZeRO derivation, checkpointing, fault tolerance.
4. [Training_Optimization](Training_Optimization.md) — Mixed precision, activation checkpointing, gradient accumulation, Transformer Engine.
5. [Modern_Post_Training](Modern_Post_Training.md) — DPO, GRPO, RLHF, distillation.
6. [Reasoning_Models](Reasoning_Models.md) — o1/o3/R1, long-CoT RL, test-time compute.
...
After this layer, ascend to [L8 -- Inference & Serving](../L8_Inference_and_Serving/Index.md).
