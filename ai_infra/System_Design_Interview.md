...
**Prerequisites**: All preceding pages, especially [Production_Architecture](Production_Architecture.md), [Inference_Frameworks](Inference_Frameworks.md), [Distributed_Training](Distributed_Training.md).
...
For full derivations see [Memory_Hierarchy_and_Roofline](Memory_Hierarchy_and_Roofline.md), [GPU_Architecture](GPU_Architecture.md), [Networking_and_Interconnect](Networking_and_Interconnect.md).
...
(Cribbed from [Production_Architecture](Production_Architecture.md).)
...
**See also:** [Production_Architecture](Production_Architecture.md), [Inference_Frameworks](Inference_Frameworks.md), [Distributed_Training](Distributed_Training.md).
