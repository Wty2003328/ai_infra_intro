...
> **Prerequisites:** [On_Chip_Memory_Hardware](On_Chip_Memory_Hardware.md), [FP_Unit_Design](FP_Unit_Design.md), [Systolic_Arrays_and_Dataflow](Systolic_Arrays_and_Dataflow.md). RTL fluency (FFs, FSMs, FIFOs).
> **Hands off to:** [L3 Microarchitecture](../L3_Microarchitecture/Index.md) — where these patterns become SMs, ISAs, and rooflines.
...
Each stage now has ~10 FO4 of logic + 4 FO4 of FF overhead = ~14 FO4 ≈ 84 ps at N4 — well under the 500 ps budget at 2 GHz. Cost: 5-cycle execution latency per FMA. The warp scheduler must issue independent FMAs to keep the pipeline full (covered in [L3 GPU_Architecture](../L3_Microarchitecture/Index.md)).
...
**Cross-references**
- [`digital_design/Synthesis_and_Optimization.md`](../../hardware_design/04_Synthesis/Synthesis_and_Optimization.md) — synthesis flow and timing closure tools.
...
- [`digital_design/Clock_Division.md`](../../hardware_design/03_Frontend_RTL_and_Verification/Clock_Division.md) — PLLs and clock generation.

---

**Up the stack:** [L3 Microarchitecture](../L3_Microarchitecture/Index.md) — these RTL patterns become SMs, ISAs, and rooflines.
**Down the stack:** [Systolic_Arrays_and_Dataflow](Systolic_Arrays_and_Dataflow.md), [FP_Unit_Design](FP_Unit_Design.md), [On_Chip_Memory_Hardware](On_Chip_Memory_Hardware.md).
