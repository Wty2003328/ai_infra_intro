...
**Prerequisites**: [Inference_Frameworks](Inference_Frameworks.md), [Kubernetes_and_Orchestration](Kubernetes_and_Orchestration.md), [Prefill_Decode_Disaggregation](../Part_6_Inference_Engines_and_Serving/Prefill_Decode_Disaggregation.md), [Observability_and_Debugging](Observability_and_Debugging.md).
...
For peak workloads with strict SLOs and bursty long prompts, split into prefill pool and decode pool. See [Prefill_Decode_Disaggregation](../Part_6_Inference_Engines_and_Serving/Prefill_Decode_Disaggregation.md).
...
KV cache reuse across requests sharing a prefix. Engine-level. See [KV_Cache §5](../Part_6_Inference_Engines_and_Serving/KV_Cache.md).
...
**Next:** [System_Design_Interview](../interview_prep/System_Design_Interview.md).
**See also:** [Inference_Frameworks](Inference_Frameworks.md), [Kubernetes_and_Orchestration](Kubernetes_and_Orchestration.md), [Prefill_Decode_Disaggregation](../Part_6_Inference_Engines_and_Serving/Prefill_Decode_Disaggregation.md), [Observability_and_Debugging](Observability_and_Debugging.md).
