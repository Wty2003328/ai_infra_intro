...
**Prerequisites**: [Inference_Frameworks](Inference_Frameworks.md), [KV_Cache](../Part_6_Inference_Engines_and_Serving/KV_Cache.md), [Batching_and_Scheduling](../Part_6_Inference_Engines_and_Serving/Batching_and_Scheduling.md).
...
```
Actually each layer has its own per-block tensor. Per layer: `2 · 16 · 8 · 128 · 2 = 65,536 bytes = 64 KB`. Total per block across all 80 layers: `80 · 64 KB = 5 MB`. Token-level: 5 MB / 16 = 320 KB/token (matches our [KV_Cache](../Part_6_Inference_Engines_and_Serving/KV_Cache.md) numbers).
...
**See also:** [Inference_Frameworks](Inference_Frameworks.md), [KV_Cache](../Part_6_Inference_Engines_and_Serving/KV_Cache.md), [Batching_and_Scheduling](../Part_6_Inference_Engines_and_Serving/Batching_and_Scheduling.md), [Speculative_Decoding](../Part_6_Inference_Engines_and_Serving/Speculative_Decoding.md).
