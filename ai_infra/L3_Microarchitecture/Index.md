...
- [`digital_design/CPU_Architecture.md`](../../digital_design/CPU_Architecture.md) — the CPU side of the SIMT/VLIW comparison.
- [`digital_design/Synthesis_and_Optimization.md`](../../digital_design/Synthesis_and_Optimization.md) — what synthesis sees of these microarchitectures.
