...
> **Layer:** L7.
> **Prerequisites:** [Modern_Post_Training](05_Modern_Post_Training.md), [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md), [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md).
> **Hands off to:** [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md), [Batching_and_Scheduling](../L8_Inference_and_Serving/03_Batching_and_Scheduling.md).
...
The thinking phase dominates. At 30 tok/s, 10,000 thinking tokens take 333 seconds (5.5 minutes). This is why reasoning model serving requires aggressive batching and high-throughput decode configurations (see [Batching_and_Scheduling](../L8_Inference_and_Serving/03_Batching_and_Scheduling.md)).
...
- **Up:** [L7 Index](00_Index.md) -- Training Stack overview.
- **Previous:** [Modern_Post_Training](05_Modern_Post_Training.md) -- DPO, GRPO, RLHF, distillation (the techniques underlying reasoning RL).
- **Down:** [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md) -- serving system design, must accommodate reasoning models' 5--10$\times$ token multiplier.
- **Down:** [Batching_and_Scheduling](../L8_Inference_and_Serving/03_Batching_and_Scheduling.md) -- prefill/decode scheduling for long-thinking-trace requests.
- **Cross:** [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md) -- KV cache sizing for reasoning-length contexts.
- **Cross:** [Modern_KV_Compression](../L8_Inference_and_Serving/02_Modern_KV_Compression.md) -- essential for fitting reasoning-length KV caches.
- **Cross:** [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md) -- MLA and GQA reduce KV cache pressure during reasoning.
- **Cross:** [Frontier_Models_2025_2026](../L6_Algorithms_and_Models/07_Frontier_Models_2025_2026.md) -- architectural specs for reasoning-capable base models.
