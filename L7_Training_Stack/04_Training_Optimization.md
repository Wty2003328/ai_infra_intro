...
> **Layer:** L7.
> **Prerequisites:** [Distributed_Training](03_Distributed_Training.md), [FP_Unit_Design](../L2_Digital_Design_for_AI/02_FP_Unit_Design.md), [Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md).
> **Hands off to:** [Modern_Post_Training](05_Modern_Post_Training.md), [Reasoning_Models](06_Reasoning_Models.md).
...
> This section covers the FP8 delayed-scaling foundation. The TE v2 extension — FP6/FP4 support, MXFP block scaling, and per-tensor current scaling — is in [Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md) §6.
...
**Up the stack:** [Modern_Post_Training](05_Modern_Post_Training.md) — DPO, GRPO, RLHF, distillation. [Reasoning_Models](06_Reasoning_Models.md) — long-CoT RL, test-time compute scaling.

**Down the stack:** [Distributed_Training](03_Distributed_Training.md) — FSDP, ZeRO derivation, checkpointing at scale. [FP_Unit_Design](../L2_Digital_Design_for_AI/02_FP_Unit_Design.md) — multiplier area, Wallace trees, the 2$\times$ throughput law. [Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md) — FP8/FP4 format encodings, Transformer Engine v2 internals, calibration pipelines.
