...
> **Layer:** L7.
> **Prerequisites:** [Parallelism_Strategies](01_Parallelism_Strategies.md), [Networking_and_Interconnect](../L4_Systems_and_Interconnects/01_Networking_and_Interconnect.md), [Rack_Scale_Design](../L4_Systems_and_Interconnects/02_Rack_Scale_Design.md).
> **Hands off to:** [Distributed_Training](03_Distributed_Training.md), [Training_Optimization](04_Training_Optimization.md).
...
**Cross-references**
- [Networking_and_Interconnect](../L4_Systems_and_Interconnects/01_Networking_and_Interconnect.md) — InfiniBand, NVLink, and topology primitives.
- [Rack_Scale_Design](../L4_Systems_and_Interconnects/02_Rack_Scale_Design.md) — how NVLink domains map to physical rack layout.
- [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md) — NVLink and NVSwitch within the GPU system.
- [Parallelism_Strategies](01_Parallelism_Strategies.md) — which parallelism strategies use which collectives.
- [Distributed_Training](03_Distributed_Training.md) — end-to-end training loop with overlapped communication.
- [Training_Optimization](04_Training_Optimization.md) — gradient compression, overlapping, and mixed-precision communication.

---

**Up the stack:** [Distributed_Training](03_Distributed_Training.md), [Training_Optimization](04_Training_Optimization.md).
**Down the stack:** [Parallelism_Strategies](01_Parallelism_Strategies.md), [Networking_and_Interconnect](../L4_Systems_and_Interconnects/01_Networking_and_Interconnect.md), [Rack_Scale_Design](../L4_Systems_and_Interconnects/02_Rack_Scale_Design.md), [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md).
