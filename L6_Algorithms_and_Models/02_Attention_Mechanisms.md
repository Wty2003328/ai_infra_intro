...
> **Layer:** L6.
> **Prerequisites:** [Transformer_Internals](01_Transformer_Internals.md), [FlashAttention_Deep_Dive](../L5_Kernels_and_Programming/05_FlashAttention_Deep_Dive.md).
> **Hands off to:** [Modern_MoE](03_Modern_MoE.md), [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md), [Long_Context_Engineering](../L8_Inference_and_Serving/06_Long_Context_Engineering.md).
...
> This page assumes the attention block's place in the forward pass — QKV projection shapes, output projection, and per-block FLOP/parameter accounting — from [Transformer_Internals](01_Transformer_Internals.md) §4 and §9.
...
**Up (deeper):**
- [Transformer_Internals](01_Transformer_Internals.md) — the full forward pass, embedding, normalization, positional encodings
- [FlashAttention_Deep_Dive](../L5_Kernels_and_Programming/05_FlashAttention_Deep_Dive.md) — tiled kernel implementation, SRAM budgeting, v1/v2/v3 progression
- [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md) — SM structure, HBM vs SRAM, tensor cores

**Down (higher level):**
- [Modern_MoE](03_Modern_MoE.md) — MoE routing operates alongside attention in each transformer layer
- [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md) — paged KV cache, eviction, and memory management for the variants defined here
- [Long_Context_Engineering](../L8_Inference_and_Serving/06_Long_Context_Engineering.md) — ring attention, context parallelism, and sparse attention at 1M+ tokens

**Lateral:**
- [Quantization](05_Quantization.md) — FP8/FP4 attention, quantized KV cache
- [State_Space_Models_and_Hybrids](04_State_Space_Models_and_Hybrids.md) — attention alternatives (Mamba, RWKV)
- [Frontier_Models_2025_2026](07_Frontier_Models_2025_2026.md) — which models use which attention variant
