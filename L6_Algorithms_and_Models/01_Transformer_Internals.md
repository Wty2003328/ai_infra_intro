...
> **Layer:** L6.
> **Prerequisites:** [FlashAttention_Deep_Dive](../L5_Kernels_and_Programming/05_FlashAttention_Deep_Dive.md), [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md).
> **Hands off to:** [Attention_Mechanisms](02_Attention_Mechanisms.md), [Quantization](05_Quantization.md), [Frontier_Models_2025_2026](07_Frontier_Models_2025_2026.md).
...
| DeepSeek-V3 | 61 | 7168 | 128 | MLA ($d_c\!=\!512$) | 128 | 18432 | 129K | 671B (37B active) |
...
> This section fixes the dimensions, projections, and FLOP accounting of the attention block. Variant-level treatment — MHA vs MQA vs GQA vs MLA tradeoffs, online softmax, KV-cache implications — lives in [Attention_Mechanisms](02_Attention_Mechanisms.md).
...
- **Up:** [L6 Index](00_Index.md) — Algorithms & Model Architectures overview.
- **Down:** [Attention_Mechanisms](02_Attention_Mechanisms.md) — detailed attention variants (MHA, MQA, GQA, MLA), online softmax derivation.
- **Down:** [Quantization](05_Quantization.md) — integer quantization methods that reduce the weight memory and FLOP counts derived here.
- **Down:** [Frontier_Models_2025_2026](07_Frontier_Models_2025_2026.md) — how these architectural components are composed in production models.
- **Cross:** [FlashAttention_Deep_Dive](../L5_Kernels_and_Programming/05_FlashAttention_Deep_Dive.md) — the kernel that makes the attention block compute-bound.
- **Cross:** [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md) — where each operation falls on the roofline.
- **Cross:** [KV_Cache](../L8_Inference_and_Serving/01_KV_Cache.md) — KV cache layout, PagedAttention, and memory management.
- **Cross:** [Parallelism_Strategies](../L7_Training_Stack/01_Parallelism_Strategies.md) — tensor, pipeline, and expert parallelism over these blocks.
