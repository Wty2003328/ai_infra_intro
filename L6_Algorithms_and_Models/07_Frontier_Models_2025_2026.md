...
> **Layer:** L6.
> **Prerequisites:** [Transformer_Internals](01_Transformer_Internals.md), [Attention_Mechanisms](02_Attention_Mechanisms.md), [Modern_MoE](03_Modern_MoE.md), [Modern_Quantization_Frontier](06_Modern_Quantization_Frontier.md).
> **Hands off to:** [Reasoning_Models](../L7_Training_Stack/06_Reasoning_Models.md), [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md).
...
**Up the stack:** [Reasoning_Models](../L7_Training_Stack/06_Reasoning_Models.md) for the full RL pipeline, [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md) for serving these models at scale.
**Down the stack:** [Transformer_Internals](01_Transformer_Internals.md), [Attention_Mechanisms](02_Attention_Mechanisms.md), [Modern_MoE](03_Modern_MoE.md), [Modern_Quantization_Frontier](06_Modern_Quantization_Frontier.md).
