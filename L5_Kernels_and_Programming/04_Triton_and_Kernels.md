...
> **Layer:** L5.
> **Prerequisites:** [CUDA_Programming](01_CUDA_Programming.md), [CUDA_Optimization](02_CUDA_Optimization.md), [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md).
> **Hands off to:** [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md), [Cutting_Edge_Kernels](06_Cutting_Edge_Kernels.md), [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md).
...
The surrounding kernel-DSL ecosystem — CUTLASS-Python/CuteDSL, TileLang, ThunderKittens, and vendor DSLs — is surveyed in [Cutting_Edge_Kernels](06_Cutting_Edge_Kernels.md).
...
The production kernel adds causal masking, KV padding, and paged KV. See [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md) for the complete algorithm.
...
> CUTLASS 3.x architecture, CuTe layout algebra, TMA-aware mainloops, warp specialization, epilogue fusion, and the CUTLASS-vs-Triton decision flowchart are covered in depth in [Cutting_Edge_Kernels](06_Cutting_Edge_Kernels.md) §3 (CUTLASS-Python/CuteDSL in §4).
...
**Cross-references**
- [CUDA_Programming](01_CUDA_Programming.md) — thread/block/memory foundation.
- [CUDA_Optimization](02_CUDA_Optimization.md) — coalescing, shared memory, tensor cores: what Triton automates.
- [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md) — tensor core microarchitecture.
- [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md) — roofline model for kernel bottleneck analysis.
- [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md) — complete FA v1→v2→v3 walkthrough.
- [Cutting_Edge_Kernels](06_Cutting_Edge_Kernels.md) — CUTLASS 3.x internals, FlashInfer, DeepEP, TileLang.

---

**Up the stack:** [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md), [Cutting_Edge_Kernels](06_Cutting_Edge_Kernels.md), [Attention_Mechanisms](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md).
**Down the stack:** [CUDA_Programming](01_CUDA_Programming.md), [CUDA_Optimization](02_CUDA_Optimization.md), [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md).
