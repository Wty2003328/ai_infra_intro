...
> **Layer:** L5.
> **Prerequisites:** [Triton_and_Kernels](04_Triton_and_Kernels.md), [CUDA_Optimization](02_CUDA_Optimization.md), [Blackwell_Architecture](../L3_Microarchitecture/04_Blackwell_Architecture.md).
> **Hands off to:** [Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md), [vLLM_Internals](../L8_Inference_and_Serving/09_vLLM_Internals.md), [Inference_Frameworks](../L8_Inference_and_Serving/08_Inference_Frameworks.md).
...
> **Moved:** the full Triton 3.x feature survey now lives in [Triton_and_Kernels](04_Triton_and_Kernels.md) §2, next to the Triton programming model it extends.
>
...
> **Moved:** the FA4 deep dive now lives in [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md) §6, following the FA-1 → FA-3 lineage.
>
...
**Up:** [Index](00_Index.md) | [Triton_and_Kernels](04_Triton_and_Kernels.md) | [CUDA_Optimization](02_CUDA_Optimization.md) | [FlashAttention_Deep_Dive](05_FlashAttention_Deep_Dive.md)

**Down:** [Modern_Quantization_Frontier](../L6_Algorithms_and_Models/06_Modern_Quantization_Frontier.md) | [vLLM_Internals](../L8_Inference_and_Serving/09_vLLM_Internals.md) | [Inference_Frameworks](../L8_Inference_and_Serving/08_Inference_Frameworks.md)

**Cross:** [Blackwell_Architecture](../L3_Microarchitecture/04_Blackwell_Architecture.md) | [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md) | [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md)
