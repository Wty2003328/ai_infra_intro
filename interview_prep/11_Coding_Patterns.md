...
**Prerequisites**: [CUDA_Programming](../L5_Kernels_and_Programming/01_CUDA_Programming.md), [CUDA_Optimization](../L5_Kernels_and_Programming/02_CUDA_Optimization.md), [Triton_and_Kernels](../L5_Kernels_and_Programming/04_Triton_and_Kernels.md), [Batching_and_Scheduling](../L8_Inference_and_Serving/03_Batching_and_Scheduling.md).
...
Key: subtract max **before** exp for numerical stability. Online (block-wise) softmax needed when N exceeds BLOCK_N — see [Attention_Mechanisms §3](../L6_Algorithms_and_Models/02_Attention_Mechanisms.md).
...
Whiteboard expectation: you should be able to write this skeleton — outer loop over Q blocks, inner over K/V, online softmax accumulator — in 20-30 minutes. See [FlashAttention_Deep_Dive §12](../L5_Kernels_and_Programming/05_FlashAttention_Deep_Dive.md) for the full version.
...
**See also:** [CUDA_Programming](../L5_Kernels_and_Programming/01_CUDA_Programming.md), [CUDA_Optimization](../L5_Kernels_and_Programming/02_CUDA_Optimization.md), [Triton_and_Kernels](../L5_Kernels_and_Programming/04_Triton_and_Kernels.md), [System_Design_Interview](10_System_Design_Interview.md).
