...
**Prerequisites**: All preceding pages, especially [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md), [Inference_Frameworks](../L8_Inference_and_Serving/08_Inference_Frameworks.md), [Distributed_Training](../L7_Training_Stack/03_Distributed_Training.md).
...
For full derivations see [Memory_Hierarchy_and_Roofline](../L3_Microarchitecture/03_Memory_Hierarchy_and_Roofline.md), [GPU_Architecture](../L3_Microarchitecture/02_GPU_Architecture.md), [Networking_and_Interconnect](../L4_Systems_and_Interconnects/01_Networking_and_Interconnect.md).
...
(Cribbed from [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md).)
...
**Next:** [Common_Interview_Questions](09_Common_Interview_Questions.md).
**See also:** [Production_Architecture](../L8_Inference_and_Serving/15_Production_Architecture.md), [Inference_Frameworks](../L8_Inference_and_Serving/08_Inference_Frameworks.md), [Distributed_Training](../L7_Training_Stack/03_Distributed_Training.md).
